...
> Describes a simple scenario based on Istio Bookinfo sample

作者：Vadim Eisenberg

原文地址：https://istio.io/blog/2018/egress-tcp.html
...
![bookinfo](https://istio.io/docs/guides/img/bookinfo/withistio.svg)
...
![The Bookinfo application with ratings v2-mysql and an external MySQL database](https://istio.io/blog/2018/img/bookinfo-ratings-v2-mysql-external.svg)
...
![The Ratings service error message](https://istio.io/blog/2018/img/errorFetchingBookRating.png)
...
![Book Ratings Displayed Correctly](https://istio.io/blog/2018/img/externalMySQLRatings.png)
...
Note that the scenario described in this post is different from the mesh expansion scenario, described in the [Integrating Virtual Machines]({{home}}/docs/guides/integrating-vms.html) guide. In that scenario, a MySQL instance runs on an external
...
[mutual TLS authentication]({{home}}/docs/concepts/security/mutual-tls.html). There is no need to create an egress rule to access this service; however, the service must be registered with Istio. To enable such integration, Istio components (_Envoy proxy_, _node-agent_, _istio-agent_) must be installed on the machine and the Istio control plane (_Pilot_, _Mixer_, _CA_) must be accessible from it. See the [Istio Mesh Expansion]({{home}}/docs/setup/kubernetes/mesh-expansion.html) instructions for more details.
